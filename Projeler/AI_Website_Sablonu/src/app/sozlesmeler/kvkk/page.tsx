      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-6 text-gray-300 leading-relaxed">
          ...
          <p>
            ...
            veri sorumlusu sıfatıyla <strong className="text-white">[TİCARİ UNVAN]</strong> olarak
          ...
          <p>
            ...
            <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@example.com"}`} className="text-[#4F8BFF] hover:underline">
