...
// TODO: kendi sosyal medya platformlarinizi ve istatistiklerinizi girin
const platforms = [
  {
    name: 'Instagram',
    handle: '@[KULLANICI_HANDLE]',
    followers: '[TAKİPÇİ SAYISI]',
    icon: <Instagram className="w-6 h-6" />,
    gradient: 'from-blue-500 to-blue-600',
    bgGlow: 'rgba(237, 234, 227, 0.15)',
    textColor: 'text-blue-400',
    href: 'https://instagram.com/[KULLANICI_HANDLE]',
    metric: 'Takipçi',
    engagementLabel: 'Erişim / Post',
    engagementValue: '[DEĞER]'
  },
  {
    name: 'TikTok',
    handle: '@[KULLANICI_HANDLE]',
    ...
    textColor: 'text-blue-400',
    href: 'https://tiktok.com/@[KULLANICI_HANDLE]',
    metric: 'Takipçi',
  ...
  },
  {
    name: 'YouTube',
    handle: '@[KULLANICI_HANDLE]',
    followers: '[ABONE SAYISI]',
    icon: <Youtube className="w-6 h-6" />,
    gradient: 'from-stone-500 to-stone-600',
    bgGlow: 'rgba(239, 68, 68, 0.15)',
    textColor: 'text-stone-400',
    href: 'https://youtube.com/@[KULLANICI_HANDLE]',
    metric: 'Abone',
    engagementLabel: 'Ort. İzlenme',
    engagementValue: '[DEĞER]'
  }
...
// TODO: kendi one cikan calismalarinizi girin (videolari /public/videos/ altina koyun)
const virals = [
  { brand: '[İŞ BİRLİĞİ 1]', views: '[İZLENME]', type: 'Organik', href: '#', videoUrl: '/videos/video-1.mp4', gradient: 'from-blue-600 via-blue-500 to-blue-500', iconBg: 'bg-blue-500/30' },
  { brand: '[İŞ BİRLİĞİ 2]', views: '[İZLENME]', type: 'Organik', href: '#', videoUrl: '/videos/video-2.mp4', gradient: 'from-blue-500 via-blue-600 to-blue-600', iconBg: 'bg-blue-500/30' },
  { brand: '[İŞ BİRLİĞİ 3]', views: '[İZLENME]', type: 'Organik', href: '#', videoUrl: '/videos/video-3.mp4', gradient: 'from-stone-500 via-stone-500 to-blue-600', iconBg: 'bg-stone-500/30' },
];

const brands = ['[MARKA 1]', '[MARKA 2]', '[MARKA 3]', '[MARKA 4]'];
      ...
      <section ref={heroRef} className="relative min-h-[85vh] flex items-center justify-center overflow-hidden" id="collaborations">
        ...
        <motion.div style={{ y: textY }} className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            >
              [MARKA
              <span className="text-gradient-accent block sm:inline"> ADI]</span>
            </motion.h1>
            ...
            >
              [İÇERİK ÜRETİCİ TANIMI — kitleye nasıl ulaştığınızı anlatın]
            </motion.p>
          ...
          >
            ...
            <Image
              src="/images/portrait.webp" /* TODO: kendi fotografinizi koyun */
              alt="[MARKA ADI]"
              width={340}
              height={340}
              quality={90}
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <span>{process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@example.com"}</span>
