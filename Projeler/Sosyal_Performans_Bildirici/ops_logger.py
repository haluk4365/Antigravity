...
==================================================
Operasyonel logları hem stdout'a hem bir Notion DB'sine yazan ortak modül.
...
Özellikler:
  ...
  - NOTION_TOKEN ile çalışır
  - NOTION_DB_OPS_LOG env variable'ı ile DB ID alır (boşsa Notion'a yazmaz)
"""
