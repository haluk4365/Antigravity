...
### Grup 1 — Sheets Pipeline

| Proje | Pipeline | Kontrol |
|-------|----------|---------|
| Lead Pipeline — Tele Satış CRM | Sheets → Notion | Tab, Header, Notion Property, Veri Kalitesi |
| Lead Notifier Bot | Sheets → Email/Telegram | Tab, Header, Veri Kalitesi |

### Grup 2 — Notion Tabanlı

| Proje | Pipeline | Beklenen Aktivite |
|-------|----------|-------------------|
| Marka İş Birliği | Notion DB | Haftada 3 gün |
| Blog Yazıcı | Notion Ops Log | Günlük (değişken) |
| Reels Kapak | Notion DB | Talep bazlı |
| İşbirliği Tahsilat Takip | Notion DB | Vade bazlı |
| LinkedIn Video Paylaşım | Notion DB | Günlük UTC 10:00 |
| LinkedIn Text Paylaşım | Notion DB | Haftada 2 gün |
| Twitter Video Paylaşım | Notion DB | Günde 3 kez |
| YouTube Kapak | Notion + Drive | Talep bazlı |

### Grup 3 — Railway Servisleri

| Proje | Pipeline | Beklenen Aktivite |
|-------|----------|-------------------|
| SWC Email Responder | Railway | Günlük |
| Shorts Demo Otomasyonu | Railway | Talep bazlı |
| Ceren İzlenme Notifier | Railway + Apify | Günlük |

### Grup 4 — Lokal / Özel

| Proje | Platform | Notlar |
|-------|----------|--------|
| E-posta Asistanı | Windows Task Scheduler | Günlük 12:00 — Gmail + Groq AI |
| Dubai Emlak İçerik Yazarı | Lokal Python | İçerik üretim pipeline'ı |
| Emlak Arazi Drone Çekim | Lokal Python | Çekim organizasyon otomasyonu |
| Örnek AI Website | Netlify (Next.js) | Static site — Railway izleme yok |
