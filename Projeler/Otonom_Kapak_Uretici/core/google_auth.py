...
def _get_credentials(account: str = "outreach") -> Credentials:
    ...
    Args:
        account: "outreach" (<GOOGLE_HESABI>), "swc" (<GOOGLE_HESABI>)
                 veya "account2" (<GOOGLE_HESABI>)
...
def gmail_outreach():
    """<GOOGLE_HESABI> Gmail service — kısa yol."""
...
def gmail_account2():
    """<GOOGLE_HESABI> Gmail service — kısa yol."""
    return get_gmail_service("account2")


def sheets_outreach():
    """<GOOGLE_HESABI> Sheets service — kısa yol."""
...
def sheets_account2():
    """<GOOGLE_HESABI> Sheets service — kısa yol."""
    return get_sheets_service("account2")
