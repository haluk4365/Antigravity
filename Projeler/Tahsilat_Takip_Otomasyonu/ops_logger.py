...
==================================================
Notion tabanlı, projeler arası yeniden kullanılabilir
operational log modülü.
...
# Operational log DB ID — .env'den NOTION_DB_OPS_LOG ile ver (boşsa sadece console).
