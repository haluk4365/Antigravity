#!/usr/bin/env python3
"""
Örnek Hesaplama Aracı — Gayrimenkul Yatırım Senaryosu
======================================================
NOT: Bu dosya, içerik yazarı agent'ine "niş-spesifik bir hesaplama aracı"
örneğidir. Burada bir gayrimenkul yatırım senaryosu hesaplanıyor (mortgage
taksidi, değer projeksiyonu, kira getirisi). Senin nişin farklıysa bu dosyayı
kendi hesaplama mantığınla değiştir veya sil.

Amaç şu deseni göstermek: agent, rakam/hesap içeren içerik üretirken bu tür bir
deterministik tool'u çağırır, sonucu script'in içine tablo olarak yerleştirir.

Varsayılan metrikler örnek değerlerdir — kendi nişine göre güncelle:
...
def run_scenario_from_args():
    ...
    print("=" * 60)
    print("  ÖRNEK YATIRIM HESAP MAKİNESİ")
    print("=" * 60)
    print()
