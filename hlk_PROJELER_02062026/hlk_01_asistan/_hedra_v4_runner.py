...
# Use previously created assets
IMG_ID = "fbc260de-8eee-4ffc-a5a8-d333239527f1"
AUD_ID = "2714a4a9-a3c6-47a5-b3c3-d33a50d627df"
AVATAR_MODEL = "26f0fc66-152b-40ab-abed-76c43df99bc8"  # Hedra Avatar
...
print("1/4 Karakter videosu olusturuluyor...")
payload = {
    "type": "video",
    ...
    "generated_video_inputs": {
        "text_prompt": "Professional Turkish female AI assistant in dark setting, warm confident expression, half-body shot, cinematic lighting, dark background",
        "aspect_ratio": "9:16",
...
# Wait for completion
print("2/4 Tamamlanmasi bekleniyor...")
start = time.time()
max_wait = 600
video_url = None
...
print("4/4 Hedra runner temizleniyor...")
