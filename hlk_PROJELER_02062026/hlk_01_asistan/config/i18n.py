...
PRICING = {
    ...
    "approved_toast": {"tr": "Fiyat teklifi onaylandı!", "en": "Price offer approved!", "de": "Preisangebot bestätigt!", "fr": "Offre de prix approuvée !", "es": "¡Oferta de precio aprobada!", "ar": "تمت الموافقة على عرض السعر!", "ru": "Ценовое предложение одобрено!", "kr": "Pêşniyara bihayê hate pejirandin!"},
    "rejected_toast": {"tr": "Teklif reddedildi", "en": "Offer rejected", "de": "Angebot abgelehnt", "fr": "Offre refusée", "es": "Oferta rechazada", "ar": "تم رفض العرض", "ru": "Предложение отклонено", "kr": "Pêşniyar hate red kirin"},
    "item_scenario": {"tr": "Senaryo Hazırlama (HLK Yapay Zeka)", "en": "Script Preparation (HLK AI)", "de": "Drehbucherstellung (HLK KI)", "fr": "Préparation du Script (HLK IA)", "es": "Preparación de Guion (HLK IA)", "ar": "إعداد السيناريو (HLK AI)", "ru": "Подготовка Сценария (HLK ИИ)", "kr": "Amadekirina Senaryoye (HLK AI)"},
    "item_video": {"tr": "Video Uretimi", "en": "Video Production", "de": "Videoproduktion", "fr": "Production Video", "es": "Produccion de Video", "ar": "انتاج الفيديو", "ru": "Производство Видео", "kr": "Hilberina Vidyoye"},
    "item_voice": {"tr": "Profesyonel Seslendirme", "en": "Professional Voiceover", "de": "Professionelle Sprachausgabe", "fr": "Voix Off Professionnelle", "es": "Voz en Off Profesional", "ar": "تعليق صوتي احترافي", "ru": "Профессиональная Озвучка", "kr": "Dengderketina Profesyonel"},
    "item_music": {"tr": "Telifsiz Fon Muzigi", "en": "Royalty-Free Background Music", "de": "Lizenzfreie Hintergrundmusik", "fr": "Musique de Fond Libre de Droits", "es": "Musica de Fondo Libre de Derechos", "ar": "موسيقى خلفية بدون حقوق", "ru": "Фоновая Музыка Без Роялти", "kr": "Muzika Paşe Be Maf"},
    "item_editing": {"tr": "Kurgu ve Montaj", "en": "Editing & Post-Production", "de": "Schnitt & Postproduktion", "fr": "Montage & Post-Production", "es": "Edicion y Postproduccion", "ar": "المونتاج وما بعد الانتاج", "ru": "Монтаж и Постпродакшн", "kr": "Montaj & Post-Hilberin"},
    "item_delivery": {"tr": "Dijital Teslim (Mp4)", "en": "Digital Delivery (Mp4)", "de": "Digitale Lieferung (Mp4)", "fr": "Livraison Numerique (Mp4)", "es": "Entrega Digital (Mp4)", "ar": "تسليم رقمي (Mp4)", "ru": "Цифровая Доставка (Mp4)", "kr": "Radestkirina Dijital (Mp4)"},
    "footer_2": {
