...
class ConstitutionScanner:
    ...
    def _build_wf_purposes(self) -> None:
        ...
        defaults = {
            "WF-001": "HLK'nın oturum boyunca çalışan Karar ve Yönetim Merkezi. 12 adımlı iş akışı: (1) Link doğrulama (GK-001_1..12), (2) Referans ürün oluşturma, (3) Ürün analizi, (4) Dinamik Bilgi Açığı Listesi, (5) Görev planı, (6) Selection Architecture ile ajan ve sağlayıcı seçimi (AR-002_19/21/22/46/46A/75), (7) Task Package oluşturma (AR-002_47), (8) Sonuç değerlendirme, (9) Information Gaps güncelleme, (10) Production Package hazırlama (AR-002_58), (11) WF-001 Work Package, (12) WF-002'ye devir. HLK = WF-001. Ajanlar karar vermez, yalnızca görev icra eder.",
